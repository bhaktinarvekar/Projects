...
class AdminRegistration extends Component {
    onChangeHandler = event => {
     ...
     onSubmitHandler = event => {
        ...
        {
            this.props.dispatch({type: ERROR_MESSAGES, payload: {message: "Password does not match"}})
        }
            ...
            <Container className={classes.container} Component="main" maxWidth="xs">
                <Paper className={classes.paper} elevation={3}>
                    ...
                    <div>
                        ...
                        <Grid container xs>
                            <Grid item xs={12}>
                                <Link href="/admin/login"  style={{marginLeft:"170px"}} color="primary">Already have an account? Sign In</Link>
                            </Grid>
                        </Grid>
                    </div>
                </Paper>
...
export default compose(withStyles(styles), connect(mapStateToProps))(AdminRegistration);