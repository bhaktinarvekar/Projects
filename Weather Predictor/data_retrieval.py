...
def callback(ch, method, properties, body):
	...
	# responseQ = pika.BlockingConnection(pika.ConnectionParameters(host='localhost'))
	...
	jsonObj = {"scans":scansdata, "date":year+"-"+month+"-"+day,"radar":radar_id,"username":data['username']}
